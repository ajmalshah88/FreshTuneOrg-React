    ...
    <div className="footer-footer">
      <footer className="footer-container">
        <div className="footer-container01">
          <div className="footer-container02">
            <img
              ...
              className="footer-image filter-white"
            />
            <span className="footer-text Headline5">{props.text7}</span>
          </div>
        </div>
        <div className="footer-container03">
          ...
          <span className="footer-text5">{props.text4}</span>
          <span className="footer-text6">{props.text5}</span>
        </div>
...
Footer.defaultProps = {
  text: 'About',
  text6: '© 2022 Fresh Tunes Org. All rights reserved',
  text2: 'Partnerships',
  text1: 'Blog',
  text7: 'Fresh Tune',
  text4: 'Help',
  image_src: 'ec34d6ba-240e-4df8-a857-0b0182f4c404',
  text3: 'Donors',
  image_alt: 'image',
